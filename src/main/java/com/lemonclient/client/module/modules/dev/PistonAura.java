...
public class PistonAura extends Module {
   ...
   BooleanSetting fireCheck = this.registerBoolean("Fire Check", true, () -> {
      return (Boolean)this.fire.getValue() && ((String)this.page.getValue()).equals("Calc");
   });
   ...
   BlockPos[] fireList = new BlockPos[]{new BlockPos(0, 0, 0), new BlockPos(1, 1, 1), new BlockPos(1, 1, 0), new BlockPos(1, 1, -1), new BlockPos(0, 1, 1), new BlockPos(0, 1, -1), new BlockPos(-1, 1, 1), new BlockPos(-1, 1, 0), new BlockPos(-1, 1, -1), new BlockPos(1, 0, 1), new BlockPos(1, 0, 0), new BlockPos(1, 0, -1), new BlockPos(0, 0, 1), new BlockPos(0, 0, -1), new BlockPos(-1, 0, 1), new BlockPos(-1, 0, 0), new BlockPos(-1, 0, -1), new BlockPos(0, 1, 0)};
   @EventHandler
                     ...
                     if (block != Blocks.field_150357_h && block != Blocks.field_150343_Z && block != Blocks.field_150477_bB && !this.checkPos(headPos)) {
                        ...
                        if (this.placedCrystal || BlockUtil.isAirBlock(this.crystalPos.func_177984_a()) && BlockUtil.isAirBlock(this.crystalPos.func_177981_b(2))) {
                           if (!this.placedPiston && (this.intersectsWithEntity(this.pistonPos) || !BlockUtil.canReplace(this.pistonPos))) {
                              this.reset();
                           } else if (!this.placedRedstone && (this.intersectsWithEntity(this.redStonePos) || !BlockUtil.canReplace(this.redStonePos))) {
                              this.reset();
                           } else {
                              ...
                              if (this.timer.passedDms((double)(Integer)this.delay.getValue())) {
                                 ...
                                 this.placeRedstone(this.placedCrystal && !this.placedRedstone);
                              }
   ...
   private void placeCrystal(boolean work) {
      if (work) {
         ...
         this.startBreakTimer.reset();
         this.breakTimer.reset();
         if (this.placedCrystal && (Boolean)this.fire.getValue()) {
            slot = BurrowUtil.findHotbarBlock(Items.field_151033_d.getClass());
            if (slot != -1) {
               List<BlockPos> canPos = new ArrayList();
               boolean placedFire = false;
               BlockPos[] var6 = this.fireList;
               int var7 = var6.length;

               for(int var8 = 0; var8 < var7; ++var8) {
                  BlockPos firePos = var6[var8];
                  BlockPos pos = (new BlockPos(this.targetPos.func_177958_n(), this.crystalPos.func_177956_o() + 1, this.targetPos.func_177952_p())).func_177971_a(firePos);
                  boolean cancel = false;
                  EnumFacing[] var12 = EnumFacing.values();
                  int z = var12.length;

                  for(int var14 = 0; var14 < z; ++var14) {
                     EnumFacing facing = var12[var14];
                     if (this.isPos2(this.pistonPos.func_177967_a(facing, 1), pos)) {
                        cancel = true;
                        break;
                     }
                  }

                  if (!cancel && !this.isPos2(this.pistonPos, pos) && !this.isPos2(this.redStonePos, pos)) {
                     int x = this.crystalPos.func_177958_n() - this.targetPos.func_177958_n();
                     z = this.crystalPos.func_177952_p() - this.targetPos.func_177952_p();
                     BlockPos pos1 = this.targetPos.func_177982_a(-x, 0, -z);
                     BlockPos pos2 = pos1.func_177982_a(z, 0, x);
                     BlockPos pos3 = pos1.func_177982_a(-z, 0, -x);
                     BlockPos pos4 = this.targetPos.func_177982_a(-x, 1, -z);
                     BlockPos pos5 = pos1.func_177982_a(z, 1, x);
                     BlockPos pos6 = pos1.func_177982_a(-z, 1, -x);
                     boolean air = BlockUtil.canReplace(pos1) && BlockUtil.canReplace(pos2) && BlockUtil.canReplace(pos3) && BlockUtil.canReplace(pos4) && BlockUtil.canReplace(pos5) && BlockUtil.canReplace(pos6);
                     if ((this.targetPos.func_177982_a(-x, 0, 0).func_177958_n() != pos.func_177958_n() && this.targetPos.func_177982_a(0, 0, -z).func_177952_p() != pos.func_177952_p() || this.crystalPos.func_177956_o() + 1 >= pos.func_177956_o() && air) && this.crystalPos.func_177982_a(x, 0, 0).func_177958_n() != pos.func_177958_n() && this.crystalPos.func_177982_a(0, 0, z).func_177952_p() != pos.func_177952_p()) {
                        if (BlockUtil.getBlock(pos) == Blocks.field_150480_ab) {
                           placedFire = true;
                           break;
                        }

                        if (this.canPlaceFire(pos) && !BlockUtil.isBlockUnSolid(pos.func_177977_b()) && !BlockUtil.canOpen(pos.func_177977_b()) && mc.field_71441_e.func_175623_d(pos)) {
                           canPos.add(pos);
                        }
                     }
                  }
               ...
               if (!placedFire) {
                  this.firePos = (BlockPos)canPos.stream().sorted(this::fireLevel).min(Comparator.comparing(PlayerUtil::getDistanceI)).orElse((Object)null);
   ...
   public boolean prepareSpace() {
      ...
      if (!this.canPlace(this.pistonPos)) {
         if (this.intersectsWithEntity(this.pistonPos)) {
            ...
            BlockPos offset = new BlockPos(this.crystalPos.func_177958_n() - this.targetPos.func_177958_n(), 0, this.crystalPos.func_177952_p() - this.targetPos.func_177952_p());
            BlockPos crystalOffset = this.crystalPos.func_177971_a(offset);
            BlockPos crystalOffset1 = crystalOffset.func_177971_a(offset);
            ...
            if (this.canPlace(piston) && BlockUtil.canReplace(piston) && !this.isPos2(piston, this.redStonePos)) {
               if (this.intersectsWithEntity(piston)) {
                  ...
                  BlockUtil.placeBlock(piston, EnumHand.MAIN_HAND, (Boolean)this.rotate.getValue(), (Boolean)this.packetPlace.getValue(), (Boolean)this.strict.getValue(), (Boolean)this.raytrace.getValue() && (Boolean)this.baseRaytrace.getValue(), (Boolean)this.swingArm.getValue());
               }
               ...
               if (this.intersectsWithEntity(crystalOffset1)) {
                  ...
                  BlockUtil.placeBlock(crystalOffset1, EnumHand.MAIN_HAND, (Boolean)this.rotate.getValue(), (Boolean)this.packetPlace.getValue(), (Boolean)this.strict.getValue(), (Boolean)this.raytrace.getValue() && (Boolean)this.baseRaytrace.getValue(), (Boolean)this.swingArm.getValue());
               }
               ...
               if (this.intersectsWithEntity(crystalOffset)) {
                  ...
                  BlockUtil.placeBlock(crystalOffset, EnumHand.MAIN_HAND, (Boolean)this.rotate.getValue(), (Boolean)this.packetPlace.getValue(), (Boolean)this.strict.getValue(), (Boolean)this.raytrace.getValue() && (Boolean)this.baseRaytrace.getValue(), (Boolean)this.swingArm.getValue());
               }
            } else {
               this.reset();
            }
         ...
         if (this.intersectsWithEntity(redstone)) {
            ...
            this.setItem(this.obbySlot, false);
            BlockUtil.placeBlock(redstone, EnumHand.MAIN_HAND, (Boolean)this.rotate.getValue(), (Boolean)this.packetPlace.getValue(), (Boolean)this.strict.getValue(), (Boolean)this.raytrace.getValue() && (Boolean)this.baseRaytrace.getValue(), (Boolean)this.swingArm.getValue());
            if (!(Boolean)this.dance.getValue()) {
               this.setItem(this.obbySlot, true);
            }
         }
   ...
   public PistonAura.PistonAuraPos findSpace() {
      ...
      while(true) {
         ...
         do {
            if (!var2.hasNext()) {
               PistonAura.PistonAuraPos best = (PistonAura.PistonAuraPos)list.stream().min(Comparator.comparing(PistonAura.PistonAuraPos::range)).orElse((Object)null);
               if (best == null) {
                  this.saveArray = new BlockPos[25];
                  return null;
               }
         ...
         for(int var7 = 0; var7 < var6; ++var7) {
            ...
            boolean calc = false;
            List<PistonAura.PistonAuraPos> can = new ArrayList();
            ...
            for(y = 0; y <= (Integer)this.maxY.getValue(); ++y) {
               ...
               if (!cantPlace) {
                  BlockPos[] var43 = offsets;
                  int var44 = offsets.length;

                  for(int var19 = 0; var19 < var44; ++var19) {
                     BlockPos side = var43[var19];
                     ...
                     if (cPos != null || (BlockUtil.getBlock(crystalPos) == Blocks.field_150343_Z || BlockUtil.getBlock(crystalPos) == Blocks.field_150357_h) && mc.field_71441_e.func_175623_d(crystalPos.func_177984_a()) && mc.field_71441_e.func_175623_d(crystalPos.func_177981_b(2)) && !(PlayerUtil.getDistanceI(crystalPos) > (Double)this.range.getValue()) && mc.field_71441_e.func_72872_a(Entity.class, new AxisAlignedBB(crystalPos.func_177984_a())).isEmpty() && mc.field_71441_e.func_72872_a(Entity.class, new AxisAlignedBB(crystalPos.func_177981_b(2))).isEmpty()) {
                        BlockPos normal = crystalPos.func_177971_a(offset);
                        BlockPos oneBlock = normal.func_177971_a(offset);
                        ...
                        if (!(Boolean)this.fiveB.getValue()) {
                        ...
                        if (!pistons.isEmpty()) {
                           List<BlockPos> pistonList = (List)pistons.stream().filter((p) -> {
                              BlockPos headPos = p.func_177982_a(offset.func_177958_n() * -1, 0, offset.func_177952_p() * -1);
                              ...
                              if (headBlock != Blocks.field_150357_h && headBlock != Blocks.field_150343_Z && headBlock != Blocks.field_150477_bB && headBlock != Blocks.field_150332_K && !this.checkPos(headPos)) {
                                 ...
                                 } else if ((Boolean)this.pistonCheck.getValue() && (this.hasRedstone(p) || !this.isFacing(p, headPos))) {
                                    return false;
                                 }
                                 ...
                                 if (redstonePos == null) {
                                    ...
                                    if ((Boolean)this.fire.getValue() && (Boolean)this.fireCheck.getValue()) {
                                       int slot = BurrowUtil.findHotbarBlock(Items.field_151033_d.getClass());
                                       if (slot != -1) {
                                          BlockPos origin = new BlockPos(targetPos.func_177958_n(), crystalPos.func_177956_o() + 1, targetPos.func_177952_p());
                                          BlockPos[] var13 = this.fireList;
                                          int var14 = var13.length;

                                          for(int var15 = 0; var15 < var14; ++var15) {
                                             BlockPos firePos = var13[var15];
                                             BlockPos pos = origin.func_177971_a(firePos);
                                             boolean cancel = false;
                                             EnumFacing[] var19 = EnumFacing.values();
                                             int z = var19.length;

                                             for(int var21 = 0; var21 < z; ++var21) {
                                                EnumFacing facing = var19[var21];
                                                if (this.isPos2(p.func_177967_a(facing, 1), pos)) {
                                                   cancel = true;
                                                   break;
                                                }
                                             }

                                             if (!cancel && !this.isPos2(p, pos) && !this.isPos2(redstonePos, pos)) {
                                                int x = crystalPos.func_177958_n() - targetPos.func_177958_n();
                                                z = crystalPos.func_177952_p() - targetPos.func_177952_p();
                                                BlockPos pos1 = targetPos.func_177982_a(-x, 0, -z);
                                                BlockPos pos2 = pos1.func_177982_a(z, 0, x);
                                                BlockPos pos3 = pos1.func_177982_a(-z, 0, -x);
                                                BlockPos pos4 = targetPos.func_177982_a(-x, 1, -z);
                                                BlockPos pos5 = pos1.func_177982_a(z, 1, x);
                                                BlockPos pos6 = pos1.func_177982_a(-z, 1, -x);
                                                boolean air = BlockUtil.canReplace(pos1) && BlockUtil.canReplace(pos2) && BlockUtil.canReplace(pos3) && BlockUtil.canReplace(pos4) && BlockUtil.canReplace(pos5) && BlockUtil.canReplace(pos6);
                                                if ((targetPos.func_177982_a(-x, 0, 0).func_177958_n() != pos.func_177958_n() && targetPos.func_177982_a(0, 0, -z).func_177952_p() != pos.func_177952_p() || crystalPos.func_177956_o() + 1 >= pos.func_177956_o() && air) && crystalPos.func_177982_a(x, 0, 0).func_177958_n() != pos.func_177958_n() && crystalPos.func_177982_a(0, 0, z).func_177952_p() != pos.func_177952_p()) {
                                                   if (BlockUtil.getBlock(pos) == Blocks.field_150480_ab) {
                                                      return true;
                                                   }

                                                   if (this.canPlaceFire(pos) && mc.field_71441_e.func_175623_d(pos) && !BlockUtil.isBlockUnSolid(pos.func_177977_b()) && !BlockUtil.canOpen(pos.func_177977_b())) {
                                                      return true;
                                                   }
                                                }
                                             }
                           ...
                           PistonAura.PistonAuraPos pos = new PistonAura.PistonAuraPos(crystalPos, piston, this.getRedStonePos(crystalPos, piston, offset), offset, target, targetPos, block);
                           can.add(pos);
                           if (cPos != null) {
                              calc = true;
                           }
            ...
            List<PistonAura.PistonAuraPos> paList = (List)can.stream().filter((p) -> {
            ...
            PistonAura.PistonAuraPos best = (PistonAura.PistonAuraPos)paList.stream().min(Comparator.comparing(PistonAura.PistonAuraPos::range)).orElse((Object)null);
            if (best != null) {
               sideList.add(best);
            }
         }
         ...
         if (!sideList.isEmpty()) {
            list.add(sideList.stream().min(Comparator.comparing(PistonAura.PistonAuraPos::range)).orElse((Object)null));
         }
      }
   }
   ...
   public BlockPos getRedStonePos(BlockPos crystalPos, BlockPos pistonPos, BlockPos offset) {
      ...
      if (pos != null) {
         ...
         if (this.useBlock) {
            EnumFacing[] var6 = EnumFacing.field_82609_l;
            int var7 = var6.length;

            for(var8 = 0; var8 < var7; ++var8) {
               EnumFacing facing = var6[var8];
               redstonePos = pistonPos.func_177972_a(facing);
               if (BlockUtil.canReplace(redstonePos) && !(mc.field_71439_g.func_70011_f((double)redstonePos.func_177958_n() + 0.5D, (double)redstonePos.func_177956_o() + 0.5D, (double)redstonePos.func_177952_p() + 0.5D) > (Double)this.range.getValue())) {
                  boolean can = true;
                  BlockPos[] var12 = this.fireList;
                  int var13 = var12.length;

                  for(int var14 = 0; var14 < var13; ++var14) {
                     BlockPos blockPos = var12[var14];
                     if (this.isPos2(crystalPos.func_177984_a().func_177971_a(blockPos), redstonePos)) {
                        can = false;
                        break;
                     }
                  }

                  if (can && BlockUtil.canPlaceWithoutBase(redstonePos, (Boolean)this.strict.getValue(), this.needRaytrace(redstonePos), (Boolean)this.base.getValue())) {
            ...
            BlockPos[] var17 = this.offsets;
            var8 = var17.length;

            for(int var18 = 0; var18 < var8; ++var18) {
               redstonePos = var17[var18];

               for(int i = 0; i < 2; ++i) {
                  BlockPos torch = pistonPos.func_177979_c(i).func_177971_a(redstonePos);
                  if (BlockUtil.canReplace(torch) && (torch.func_177958_n() != crystalPos.func_177958_n() || torch.func_177952_p() != crystalPos.func_177952_p()) && (torch.func_177958_n() != pistonPush.func_177958_n() || torch.func_177952_p() != pistonPush.func_177952_p()) && (i != 1 || !BlockUtil.isBlockUnSolid(torch.func_177984_a())) && !(mc.field_71439_g.func_70011_f((double)torch.func_177958_n() + 0.5D, (double)torch.func_177956_o() + 0.5D, (double)torch.func_177952_p() + 0.5D) > (Double)this.range.getValue()) && BlockUtil.canPlaceWithoutBase(torch, (Boolean)this.strict.getValue(), this.needRaytrace(torch), (Boolean)this.base.getValue())) {
                     redstone.add(torch);
                  }
               }
            }
         ...
         return (BlockPos)redstone.stream().min(Comparator.comparing(this::blockLevel)).orElse((Object)null);
      }
   }
   ...
   public BlockPos hasRedstoneBlock(BlockPos pos) {
      if (BlockUtil.getBlock(pos.func_177984_a()) == Blocks.field_150451_bX) {
         ...
         for(int var4 = 0; var4 < var3; ++var4) {
            ...
            for(int i = 0; i < 2; ++i) {
               BlockPos blockPos = pos.func_177971_a(offset).func_177979_c(i);
               Block block = BlockUtil.getBlock(blockPos);
               if (i == 0) {
                  if (block == Blocks.field_150429_aA || block == Blocks.field_150451_bX) {
                     return blockPos;
                  }
               } else if (block == Blocks.field_150429_aA && !BlockUtil.isBlockUnSolid(blockPos.func_177984_a())) {
                  return blockPos;
               }
            }
         }
   ...
   private int fireLevel(BlockPos pos, BlockPos targetPos) {
      return pos.func_177958_n() != targetPos.func_177958_n() && pos.func_177952_p() != targetPos.func_177952_p() ? 0 : 1;
   }
   ...
   public boolean canPistonCrystal(BlockPos crystalPos, BlockPos targetPos) {
      ...
      if (BlockUtil.getBlock(crystalPos) != Blocks.field_150343_Z && BlockUtil.getBlock(crystalPos) != Blocks.field_150357_h) {
         return false;
      } else if (mc.field_71441_e.func_175623_d(crystalPos.func_177984_a()) && mc.field_71441_e.func_175623_d(crystalPos.func_177981_b(2))) {
         BlockPos normal = crystalPos.func_177971_a(offset);
         BlockPos oneBlock = normal.func_177971_a(offset);
         BlockPos side0 = normal.func_177982_a(offset.func_177952_p(), 0, offset.func_177958_n());
         BlockPos side1 = normal.func_177982_a(offset.func_177952_p() * -1, 0, offset.func_177958_n() * -1);
         ...
         this.add(pistons, side4);
         this.add(pistons, side5);
         List<BlockPos> posList = new ArrayList(pistons);
         posList.removeIf((p) -> {
            if (!(Boolean)this.different.getValue()) {
               return false;
            } else {
         ...
         pistons.removeIf((p) -> {
            if (mc.field_71439_g.func_70011_f((double)p.func_177958_n() + 0.5D, (double)p.func_177956_o() + 0.5D, (double)p.func_177952_p() + 0.5D) > (Double)this.range.getValue()) {
               ...
               if (headBlock != Blocks.field_150357_h && headBlock != Blocks.field_150343_Z && headBlock != Blocks.field_150477_bB && headBlock != Blocks.field_150332_K && !this.checkPos(headPos)) {
                  boolean isPiston = BlockUtil.getBlock(p) instanceof BlockPistonBase;
                  if (!isPiston) {
                     if (!BlockUtil.canPlaceWithoutBase(p, (Boolean)this.strict.getValue(), this.needRaytrace(p), true)) {
                        return true;
                     }
                  ...
                  } else if (this.hasRedstone(p) || !this.isFacing(p, headPos)) {
                     return true;
                  }
